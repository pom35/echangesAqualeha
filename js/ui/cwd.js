	...
	this.not('.elfinder-cwd').each(function() {
		...
		var mobile = fm.UA.Mobile,
			...
			makeTemplateRow = function() {
				return '<tr id="{id}" class="'+clFile+' {permsclass} {dirclass} dragout" title="{tooltip}"{css} data-downloadurl="{dlmime}:{name}:{path}"><td class="elfinder-col-name"><div class="elfinder-cwd-file-wrapper"><span class="elfinder-cwd-icon {mime}"{style}/>{marker}<span class="elfinder-cwd-filename">{name}</span></div>'+selectCheckbox+'</td>'+customColsBuild()+'</tr>';
			},
